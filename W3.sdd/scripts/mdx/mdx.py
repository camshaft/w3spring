...
# These guys had files as their 2nd param
class KTAT(KGSC_Base):
  """ Translation """
  def __init__(self, optional=0):
    KGSC_Base.__init__(self, 'KTAT', optional)

class KTAR(KGSC_Base):
  """ Rotation """
  def __init__(self, optional=0):
    KGSC_Base.__init__(self, 'KTAR', optional)

class KTAS(KGSC_Base):
  """ Scaling """
  def __init__(self, optional=0):
    KGSC_Base.__init__(self, 'KTAS', optional)
